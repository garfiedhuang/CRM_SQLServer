...
namespace Garfield.DAL
{
	...
	public partial class Param_SysParam
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Garfield.Model.Param_SysParam model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Garfield.Model.Param_SysParam model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Garfield.Model.Param_SysParam GetModel(int id)
		{
			...
			Garfield.Model.Param_SysParam model=new Garfield.Model.Param_SysParam();
