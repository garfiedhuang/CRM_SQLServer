...
namespace Garfield.DAL
{
	...
	public partial class CRM_Contact
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Garfield.Model.CRM_Contact model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Garfield.Model.CRM_Contact model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Garfield.Model.CRM_Contact GetModel(int id)
		{
			...
			Garfield.Model.CRM_Contact model=new Garfield.Model.CRM_Contact();
