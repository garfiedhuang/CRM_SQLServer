...
namespace Garfield.DAL
{
	...
	public partial class Sys_role
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Garfield.Model.Sys_role model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Garfield.Model.Sys_role model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Garfield.Model.Sys_role GetModel(int RoleID)
		{
			...
			Garfield.Model.Sys_role model=new Garfield.Model.Sys_role();
