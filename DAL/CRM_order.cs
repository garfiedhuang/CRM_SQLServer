...
namespace Garfield.DAL
{
	...
	public partial class CRM_order
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Garfield.Model.CRM_order model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Garfield.Model.CRM_order model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[8].Value = model.Order_status;
			parameters[9].Value = model.Order_amount;			
			parameters[10].Value = model.C_dep_id;
			parameters[11].Value = model.C_dep_name;
			parameters[12].Value = model.C_emp_id;
			parameters[13].Value = model.C_emp_name;
			parameters[14].Value = model.F_dep_id;
			parameters[15].Value = model.F_dep_name;
			parameters[16].Value = model.F_emp_id;
			parameters[17].Value = model.F_emp_name;
			parameters[18].Value = model.receive_money;
			parameters[19].Value = model.arrears_money;
			parameters[20].Value = model.invoice_money;
			parameters[21].Value = model.arrears_invoice;
        ...
        /// 批量
        /// </summary>
        public bool Update_batch(Garfield.Model.CRM_order model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CRM_order set ");            
            strSql.Append("F_dep_id=@F_dep_id,");
		...
		/// 得到一个对象实体
		/// </summary>
		public Garfield.Model.CRM_order GetModel(int id)
		{
			...
			Garfield.Model.CRM_order model=new Garfield.Model.CRM_order();
