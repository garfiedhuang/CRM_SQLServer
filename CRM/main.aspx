...
<head>
    ...
    <script type="text/javascript">
        ...
        function show_welcome(item) {
            if (getCookie("garfield_crm_show_wellcome") == 1 || item == 1) {
                var dialog = $.ligerDialog.open({
                    url: "welcome.htm", width: 800, height: 500, title: "欢迎使用客户关系管理系统系统", buttons: [
                            {
                                text: '关闭', onclick: function (item, dialog) {
                                    dialog.close();
                                }
                ...
                SetCookie("garfield_crm_show_wellcome", "2");
            }
        }
...
<body>
    <form id="form1" onsubmit="return false;" action="">
        ...
        <div style="background: #d2e2f2; height: 74px; overflow: hidden;">
            <div style="height: 47px; margin: 0; padding: 0;background-color:#006699;">
                <div style="width: 278px; float: left;">
                    <a >
                        <img id="logo" alt="Logo" src="Images/logo/logo.png" style="height: 42px; margin-left: 5px; margin-top: 2px;" />
                    </a>
                </div>
                ...
                <div style="float: right; width: 220px; height: 47px; margin-right: 65px;">
                    <div style="width: 100%; height: 25px; text-align: right;">
                        <table style="width: 100%;color: white; ">
                            <tr>
                                <td>
                                    <div id="jnkc" style="font-size: 12px; text-align: right;" />
                                </td>
                            </tr>
                        </table>
                    </div>

                    <div style="width: 100%; height: 22px; line-height: 22px; vertical-align: bottom;color: white; ">
                        ...
                        <div id="Username" style="font-size: 12px; color: Red; padding-left: 18px; width: 80px; float: right;"></div>

                    </div>
                </div>

                <div id="portrait">
                    <img src="images/nopic.jpg" onerror="noheadimg();" id="userheader" width="48px" alt="头像不存在" />
                </div>
            </div>
        ...
        <div id="layout1" style="width: 100%">
            ...
            <div position="center" id="framecenter">
                <div id="home" title="桌面" style="height: 300px">
            ...
            <div position="right" title="功能菜单" id="accordion2">
                ...
                <div title="邮件列表" class="l-scroll"></div>
                <div title="个人工作" class="l-scroll"></div>
            </div>
            <div position="bottom">
                Copyright © 2017-2020 加菲猫软件 All Rights Reserved   
            </div>
        </div>
    </form>
</body>
